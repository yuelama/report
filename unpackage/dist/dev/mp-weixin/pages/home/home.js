          ...
          switch (_context.prev = _context.next) {
            case 0:
              if (options && options.tab === 'history') {
                _this.activeTab = 'history';
              }

              // 进入页面时拉取当前用户的历史报告
              _context.next = 3;
              return _this.fetchReports();
            case 3:
            case "end":
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!(!_this2.form.date || !_this2.form.title || !_this2.form.content)) {
                  _context2.next = 3;
                  break;
                }
                uni.showToast({
              ...
              case 3:
                _context2.prev = 3;
                crudBaogao = uniCloud.importObject('crud-baogao');
                _context2.next = 7;
                return crudBaogao.addReport({
